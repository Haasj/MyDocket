...
//	6/27/2013	updated to work with docket_alt instead of docket
...
//pataction_edit.php -- User Access Level: User/Viewer
include("accesscontrol.php");
html_header($fullname,$module,$orgadmin,$user_level);
$sql="SELECT title, docket_alt FROM pat_filings WHERE pat_ID='$PAT_ID'";
...
<table align="right" border="0" cellpadding="0" cellspacing="0"><tr>
  <td width="100%" align="center" bgcolor="#FFFFFF">
    ...
    <a href="delete_confirm.php?module=<?=$module;?>&TABLE=pat_actions&ID=<?=$ACTION_ID;?>&NAME=Action For Docket No. <?=$docket_alt;?>">Delete</a>&nbsp;|&nbsp;
    <?}?>
